...
void loop() {
    ...
    bool edge = updateLineSensors(500);            // 1000 is the preset threshold for the edge. Is this the best value?
    ...
    else if(prox_left_front<3 || prox_right_front<3){
      motors.setSpeeds(700,700);
      //buzzer.playFrequency(440, 200, 15);
      
    }

    else if(prox_right<20) {
